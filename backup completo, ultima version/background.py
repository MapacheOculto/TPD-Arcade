...
class Background:
    ...
    def initImagesForBackground(self):
        ...
        imageDictionary.update({"greenAlpha" : pygame.image.load("blocks//greenAlpha.png").convert()})   
        imageDictionary.update({"blue" : pygame.image.load("blocks//blue.png").convert()})
        imageDictionary.update({"blueAlpha" : pygame.image.load("blocks//blueAlpha.png").convert()})
