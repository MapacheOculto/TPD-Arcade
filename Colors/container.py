...
class Container:
    ...
    def setImages(self):
        ...
        self.imageDictionary.update({"greenAlpha" : pygame.image.load("blocks//greenAlpha.png").convert_alpha()})   
        self.imageDictionary.update({"blue" : pygame.image.load("blocks//blue.png").convert()})
        self.imageDictionary.update({"blueAlpha" : pygame.image.load("blocks//blueAlpha.png").convert_alpha()})
